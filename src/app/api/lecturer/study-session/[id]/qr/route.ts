...
export async function PUT(
  ...
  try {
    ...
    // NOTE: day_of_week parameter is used ONLY to compute validity window timestamps
    // for this specific QR code (week). It does NOT update study_session.day_of_week
    // to preserve the session's default day for other weeks.
