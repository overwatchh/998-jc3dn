...
import { Download, Loader2, QrCode, Share2, MapPin, Clock, Shield, CheckSquare, Square } from "lucide-react";
              ...
              <div className="relative mx-auto w-[clamp(250px,40vh,400px)]">
                ...
                {!qrGenerated && (
                  <div className="absolute inset-x-2 bottom-2">
                    <div className="bg-card/85 backdrop-blur-sm border border-border rounded-md px-2 py-1 text-[11px] flex items-center justify-between gap-2">
                      <span className="text-muted-foreground font-medium">Configuration Status</span>
                      <div className="flex items-center gap-3">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className={`${selectedRoomId ? 'text-green-600 dark:text-green-400' : 'text-muted-foreground'}`}>Room</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                          {windowsConfigured ? (
                            <CheckSquare className="h-3.5 w-3.5 text-green-600 dark:text-green-400" />
                          ...
                          <span className={`${windowsConfigured ? 'text-green-600 dark:text-green-400' : 'text-muted-foreground'}`}>Time Windows</span>
                        </div>
                      </div>
                    </div>
                  </div>
