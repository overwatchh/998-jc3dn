...
# Test script to create QR code with short validity windows for testing second check-in

echo "Setting up test QR code with short validity windows..."
...
# Update the existing QR code validity windows
